...
[![Tests](https://img.shields.io/badge/unit%20tests-167-success)](#тестирование)
...
Ключ Gemini у каждого свой: никакого backend, аккаунтов и телеметрии.
...
**167 юнит-тестов**, без единого обращения к сети. Покрыто то, что ломается тихо
и дорого:
...
<div align="center">
Если проект пригодился или просто понравился — поставьте ⭐, это помогает ему развиваться.
</div>
